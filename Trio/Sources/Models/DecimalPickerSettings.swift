...
struct DecimalPickerSettings {
    ...
    var autosensMax = PickerSetting(value: 1.2, step: 0.01, min: 0.5, max: 2, type: PickerSetting.PickerSettingType.factor)
    var autosensMin = PickerSetting(value: 0.7, step: 0.01, min: 0.3, max: 1, type: PickerSetting.PickerSettingType.factor)
    ...
    var adjustmentFactor = PickerSetting(value: 0.8, step: 0.01, min: 0.3, max: 3.0, type: PickerSetting.PickerSettingType.factor)
